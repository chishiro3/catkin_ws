...
set(MSG_I_FLAGS "-Iurg_node:/home/pi/csp/catkin_ws/src/urg_node/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/pi/csp/catkin_ws/src/urg_node/msg/Status.msg" NAME_WE)
add_custom_target(_urg_node_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "urg_node" "/home/pi/csp/catkin_ws/src/urg_node/msg/Status.msg" ""
)
...
_generate_msg_cpp(urg_node
  "/home/pi/csp/catkin_ws/src/urg_node/msg/Status.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/urg_node)
  install(CODE "execute_process(COMMAND \"/home/pi/csp/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/urg_node\")")
  # install generated code
  install(
